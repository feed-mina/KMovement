                ...
                headers: [
                    ...
                    },
                    {
                        ...
                        value: [
                            ...
                            "img-src 'self' data: blob: https: http://*.daumcdn.net http://*.kakaocdn.net https://*.daumcdn.net https://*.kakao.com https://*.kakaocdn.net https://maps.googleapis.com https://maps.gstatic.com https://*.googleapis.com https://*.gstatic.com",
