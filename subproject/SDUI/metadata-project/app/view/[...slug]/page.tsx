    ...
    return (
        <div className={`page-wrap ${screenId}`}>
            ...
            {screenId === "KRIDE_FOCUS" && isChatModalOpen && (
                <div className="fixed bottom-[80px] left-4 right-4 md:bottom-[90px] md:left-auto md:right-6 md:w-[380px] h-[55vh] md:h-[600px] max-h-[55vh] md:max-h-[75vh] z-[100] shadow-2xl rounded-2xl overflow-hidden border border-gray-700 bg-[#0A0A0A] flex flex-col">
                    <KrideChatComponent 
