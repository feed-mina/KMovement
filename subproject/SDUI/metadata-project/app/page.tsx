...
export const metadata: Metadata = {
    ...
    description: 'K-POP 성지와 서울 맛집을 찾고 취향에 맞는 여행 동선을 무료로 만들어 보세요.',
    alternates: { canonical: '/' },
    openGraph: { url: '/', title: 'KRIDE | AI K-컬처 여행 플래너', description: 'K-POP 성지와 서울 맛집을 연결하는 나만의 여행 동선' },
};
    ...
    return (
        <main className={styles.page}>
            ...
            <nav className={styles.nav} aria-label="주요 메뉴">
                ...
                <div className={styles.navLinks}><Link href="/travel/seoul-kpop">K-POP 여행</Link><Link href="/travel/seoul-food">서울 맛집</Link></div>
            </nav>
            ...
            <section className={styles.section}>
                ...
                <div className={styles.cardGrid}>
                    ...
                    <article className={styles.card}><h3>서울 맛집 코스</h3><p>시장과 골목, 카페를 이동 부담이 적은 하루 코스로 연결합니다.</p><Link href="/travel/seoul-food">서울 맛집 가이드 보기 →</Link></article>
