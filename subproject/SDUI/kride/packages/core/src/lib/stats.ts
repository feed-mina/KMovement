// Platform-neutral port of metadata-project/components/fields/stats/statsUtils.ts
// so the mobile STAT_CARD / CHART leaves read component_props and DATA_SOURCE
// payloads exactly the way the web admin dashboard does.
